...
**GitHub:** https://github.com/Daavox/Probabilistic-Robotics-Lab  
...
|---------|------------------------------------|---------------|-------------|
| **KF**  | Kalman Filter (linear)             | `/cmd_vel`    | `/odom`     |
...
prob_lab/
├── src/
│   ├── kf_node.cpp           # Kalman Filter (3D state: x, y, θ)
...
During dropout: only **prediction** runs, **correction** is skipped.
